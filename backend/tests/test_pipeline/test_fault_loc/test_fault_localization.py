...
class TestFaultLocalization(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.fault_loc.max_tokens, 750)  # 1000 - 250
    ...
    def test_calculate_fault_localization_single_chunk(self):
    ...
    def test_calculate_fault_localization_multiple_chunks(self):
    ...
    def test_model_response_error_handling(self):
